...
const PISM_MOD1 = "[Oficial · Programa PISM/UFJF, ed. reformulada 2022] Geografia: Espaço e representação (cartografia, projeções), Natureza e tecnologias (relevo, clima, domínios morfoclimáticos), Fontes de energia, Meio ambiente · História: África Antiga e Antiguidade Clássica, Mundo Medieval, Construção do Mundo Moderno (expansão marítima, Humanismo/Renascimento, Reforma/Contrarreforma), Colonização das Américas · Biologia: Conhecimento e Ciência, Bioquímica e Célula, características morfofuncionais/evolutivas das células, ciclo celular, histologia · Química: Constituição e propriedades da matéria (modelos atômicos, tabela periódica, ligações), transformações da matéria, Química/Ambiente/Saúde/Vida (tratamento de água) · Física: Movimento e equilíbrio (Leis de Newton, Kepler, torque), leis de conservação de energia e momento linear · Matemática (eixos BNCC): Números (conjuntos numéricos), Álgebra (funções afim, quadrática, exponencial), Geometria (triângulos, polígonos, áreas) · Língua Portuguesa: campos de atuação social (vida pessoal, vida pública, jornalístico-midiático, estudo e pesquisa, artístico-literário) · Literatura: prosa contemporânea de autoria feminina, poesia africana, negritude na poesia brasileira, pobreza na prosa brasileira — autores: Ana Paula Tavares, Carolina Maria de Jesus, Geovani Martins, Castro Alves, Conceição Evaristo, Conceição Lima, Jarid Arraes, José Craveirinha, Noémia de Sousa, Paulina Chiziane · Inglês: funções comunicativas, vocabulário essencial, interpretação de texto. Obs.: Filosofia e Sociologia não integram o Módulo I.";
const PISM_MOD2 = "[Oficial · Programa PISM/UFJF, ed. reformulada 2022] Geografia: Urbanização e cidades, Espaço agrário · História: Crise do Antigo Regime (Revoluções Inglesas, Iluminismo, Revolução Industrial, Revolução Francesa), Era das Revoluções/Independências das Américas, construção dos Estados Nacionais no séc. XIX, Brasil no séc. XIX, mundos do trabalho no séc. XIX · Biologia: diversidade dos seres vivos — vírus, bactérias, fungos, algas, protozoários, animais, plantas · Química: constituição/propriedades (compostos orgânicos, nomenclatura IUPAC), transformação da matéria (soluções, termoquímica, estequiometria), Química/Ambiente/Saúde/Vida (poluição) · Física: oscilações (MHS, ondas, acústica), temperatura e calor, termodinâmica, óptica, fluidos · Matemática: trigonometria (ciclo, seno/cosseno, triângulo qualquer), PA/PG, sólidos geométricos e volumes, estatística (medidas de tendência central/dispersão, gráficos) · Português/Literatura: cumulativo ao Módulo I; romance realista Portugal/Brasil, poesia modernista, povos indígenas — autores: Carlos Drummond de Andrade, Clarice Lispector, Eça de Queiroz, Eliane Potiguara, Gonçalves Dias, Lygia Fagundes Telles, Machado de Assis, Manuel Bandeira · Inglês: gramática instrumental, interpretação de texto.";
const PISM_MOD3 = "[Oficial · Programa PISM/UFJF, ed. reformulada 2022] Geografia: desigualdades sociais e fluxos populacionais, desenvolvimento desigual do capitalismo, globalização e fragmentação da Nova Ordem Mundial · História: Brasil Republicano 1889-1945, Era dos Extremos (Guerras Mundiais, Revolução Russa, Crise de 1929/Fascismo), Guerra Fria, Brasil democrático 1945-1964, Ditadura Civil-Militar, Brasil de Diretas-Já até hoje, mundo contemporâneo (Queda do Muro, Guerra ao Terror, Primavera Árabe, minorias sociais) · Sociologia: Sociologia como ciência, indivíduo/sociedade/instituições, identidade e cultura, trabalho/produção/tecnologias, estrutura do mundo contemporâneo, identidades e conflitos, desigualdades/violência/Direitos Humanos, democracia/participação política/cidadania · Filosofia: conhecimento, atitude filosófica, funções da Filosofia, lógica, verdade, escolas (Ceticismo/Racionalismo/Empirismo), liberdade, ética · Biologia: fundamentos de ecologia, problemas ambientais, hereditariedade, biotecnologia, teorias evolucionistas, evidências evolutivas, reprodução humana e sexualidade · Química: constituição/propriedades (modelo de Bohr, isomeria), transformação da matéria (eletroquímica, cinética, equilíbrio químico, reações orgânicas), Química/Ambiente/Saúde/Vida (aquecimento global, metais, biodiesel) · Física: eletrostática, eletricidade, energia elétrica, eletromagnetismo, física quântica e relatividade restrita · Matemática: sistemas lineares, logaritmos e função logarítmica, geometria analítica (ponto e reta), análise combinatória, probabilidade · Português/Literatura: cumulativo aos módulos anteriores; colonialismo/anticolonialismo, narrativa indígena, romance regionalista, vanguardas poéticas, homoafetividade — autores: Aílton Krenak, Ana Cristina Cesar, Augusto de Campos, Caetano Veloso, Caio Fernando Abreu, Daniel Munduruku, Graciliano Ramos, Itamar Vieira Júnior, Luís Vaz de Camões, Natália Borges Polesso, Oswald de Andrade, Patrícia Lino, Tomás Antônio Gonzaga.";
